  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] flex flex-col relative">  
      <main className="flex-grow w-full mx-auto z-10 relative">
        ...
        <div className="h-auto py-20  min-[1920px]:py-30 bg-white flex flex-col items-center justify-center relative">
          <div className="pb-10 sm:pb-20 w-[90%]  min-[1920px]:w-[70%] flex justify-start">
            <SlideUp>
          ...
          <div className="flex h-100 sm:h-200 w-[90%]  min-[1920px]:w-[70%] gap-5 min-[1920px]:gap-10 justify-center">
            {/* Column 1 */}  
            <div className="w-[40%] flex flex-col gap-5">
              ...
              <SlideUp className="h-[10%]  min-[1920px]:hidden"> 
            ...
            {/* Column 2 */}
            <div className="w-[60%]  min-[1920px]:w-[50%] flex flex-col gap-5  min-[1920px]:gap-10">

              <div className="h-[35%]  min-[1920px]:h-[70%] flex">
            ...
            <div className="w-[25%] hidden  min-[1920px]:flex sm:w-[20%] flex flex-col gap-5 sm:gap-10">
              <SlideUp className="h-[94%]  min-[1920px]:h-[90%]">
        ...
        <div className="h-auto w-full mx-auto py-10 sm:py-30 justify-center items-center flex flex-col">
          ...
          <div className="pb-10  min-[1920px]:pb-20 w-[90%]  min-[1920px]:w-[70%]">
            <SlideUp>
              <div className="font-bold text-3xl sm:text-6xl text-[#333333] tracking-tighter">
                Experience
            </div>
          ...
          <SlideUp>
            <div className="h-100 sm:h-185 justify-start flex items-center">
              <div ref={scrollRef} onScroll={checkScroll} className="flex gap-5 min-[1920px]:gap-10 overflow-x-auto no-scrollbar z-0 h-full w-full px-[5%] min-[1920px]:px-[15%]">
                {experiences.map((exp, i) => (
                  <div key={i} className="cell relative flex-shrink-0 w-[80%] min-[1920px]:w-full h-full overflow-hidden rounded-[20px] sm:rounded-[30px] bg-gray-100">
        ...
        <div className="h-auto flex flex-col justify-center items-center w-full bg-white py-20 sm:py-30">
          ...
          <SlideUp className="flex justify-center">
            <div className="w-[90%] min-[1920px]:w-[70%]  min-[1920px]:pb-20">
              <div className="font-bold text-3xl sm:text-6xl text-[#333333] tracking-tighter">
                Featured projects.
              </div>
          </div>
            ...
            <div className="w-[90%] flex flex-col min-[1920px]:flex-row justify-center">
              <SlideUp className="flex justify-center min-[1920px]:justify-end">
                <div className=" w-100 min-[1920px]:w-150 flex justify-end">
                    <Image src={unibudget} alt="noimg" className="object-center"/>
                </div>
              </SlideUp>

              <SlideUp className="flex">
                <div className="flex flex-col justify-center items-center min-[1920px]:items-start w-[100%] min-[1920px]:pb-40">
                  <div className="text-center min-[1920px]:text-left w-auto text-[#333333] tracking-normal pb-5">
                    <div className="pb-5">
                      <span className="text-md sm:text-lg font-medium">Design Project</span>
                      <div className="font-bold text-2xl sm:text-5xl pb-2">
                        UniBudget
                      </div>
                      <div className="flex justify-center min-[1920px]:justify-start text-sm gap-2 border-[#333333] tracking-normal">
                    ...
                    <p className="font-regular text-md sm:text-xl w-[100%] sm:w-[60%] mx-auto min-[1920px]:mx-0 text-center min-[1920px]:text-left">
            ...
            <div className="min-[1920px]:w-full flex flex-col min-[1920px]:flex-row justify-between items-center min-[1920px]:pl-[15%]">
                <div className="flex flex-col order-2 min-[1920px]:order-1 justify-center items-center min-[1920px]:items-start w-[60%] min-[1920px]:w-[35%] pb-20 sm:pb-40 sm:pr-0">
                  <SlideUp>
                    <div className="text-center min-[1920px]:text-left text-[#333333] tracking-tight mb-5">
                      <div className="pb-5">
                        <span className="text-md sm:text-lg  font-medium">Website Project</span>
                        <div className="font-bold text-2xl sm:text-5xl pb-2">
                          Anthill
                        </div>
                        <div className="flex justify-center min-[1920px]:justify-start text-sm tracking-normal border-[#333333] opacity-50">
                          <span className="pr-2">
                            Flask
                          </span>
                      ...
                      <p className="font-regular text-md sm:text-xl w-full sm:w-[90%] min-[1920px]:mx-0 mx-auto">
                    ...
                    <div className="flex gap-3 justify-center min-[1920px]:justify-start">
                ...
                <div className="order-1 pl-[5%] min-[1920px]:pl-0 min-[1920px]:order-2 flex py-15">
                  <SlideUp className="flex justify-end">
                    <Image src={Anthill} alt="noimg" width={1400} className="object-center"/>
                  </SlideUp>
                </div>
        ...
        <div className="h-auto w-full flex flex-col bg-white justify-center text-center items-center pb-30">
